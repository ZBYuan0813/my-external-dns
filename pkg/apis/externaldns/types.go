...
func (cfg *Config) ParseFlags(args []string) error {
	...
	app.Flag("aws-endpoint-url","When using the AWS provider, set whether to use endpoint-url").Default(defaultConfig.AWSEndpointUrl).StringVar(&cfg.AWSEndpointUrl)
